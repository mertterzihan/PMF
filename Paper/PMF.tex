...
Similarly to the Gibbs sampler used for \gls{lda} (see Section \ref{sec:elda-sampler}), a burn-in rate of $0.1$ was used (the first $0.1$ iterations were discarded) and a thining rate of $5$ was used (only every fifth iteration was recorded).
\section{Results}
